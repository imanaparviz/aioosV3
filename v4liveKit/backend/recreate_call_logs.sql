-- =====================================================
-- RECREATE call_logs table with ALL required columns
-- =====================================================

-- Drop existing table if it exists (BE CAREFUL - THIS DELETES DATA!)
DROP TABLE IF EXISTS call_logs CASCADE;

-- Create call_logs table with user_id column
CREATE TABLE call_logs (
    ...
    user_id UUID DEFAULT auth.uid() -- THIS WAS MISSING!
);
...
-- DONE!
-- =====================================================
SELECT 'Analytics setup completed successfully!' as message;
